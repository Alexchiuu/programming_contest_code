...
int main(){
    ...
    std::cout << "message : " << message << std::endl;//Addind /0 allows you to print like this
    

 
    //If a character array is null terminated, it's called as C-String
    
    char message1 [] {'H','e','l','l','o','\0'};//null terminator
    std::cout << "message1 : " << message1 << std::endl;
    std::cout << "sizeof(message1) : " << sizeof(message1) << std::endl;
    
    char message2 [6] {'H','e','l','l','o'};//auto filling null terminator
    ...
    //String literal
    char message4 [] {"Hello"};//Initializing with C string(null terminated)
