...
int main(){
    ...
    planet = "Earth. Where the sky is blue Earth. Where the sky is blue Earth. Where the sky is blue Earth";
    std::cout << "planet : " << planet << std::endl;


    //Use a raw array
    const char *planet1 {"Earth. Where the sky is blue ."};//Wasting the original memory
    planet1 = "Earth. Where the sky is blue Earth. Where the sky is blue Earth. Where the sky is blue Earth";
